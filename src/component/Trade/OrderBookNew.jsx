                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center">{row.orderType == 'buy' ? row.nbrOptions : '-'}</TableCell>
                      <TableCell align="center">{row.orderType === 'buy' ? row.bid : '-'}</TableCell>
                      <TableCell align="center">{row.orderType === 'sell' ? row.ask : '-'}</TableCell>
                      <TableCell align="center">{row.orderType === 'sell' ? row.nbrOptions : '-'}</TableCell>
